    ...
    private fun loadChartData(
        ...
        binding.detaillChartWebView.loadUrl(
            ...
            "https://s.tradingview.com/widgetembed/?frameElementId=tradingview_76d87&symbol="+
                    ...
                    "F1F3F6&studies=[]&hideideas=1&theme=Dark&style=1&timezone=Etc%2FUTC&studies_overrides={}&overrides={}&enabled_features="+"[]&disabled_features=[]&locale=en&utm_source=coinmarketcap.com&utm_medium=widget&utm_campaign=chart&utm_term=BTCUSDT"
        )
